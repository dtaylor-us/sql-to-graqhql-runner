...
var AccumoopindivtxType = new GraphQLObjectType({
    name: 'Accumoopindivtx',
    description: '@TODO DESCRIBE ME',

    fields: function getAccumoopindivtxFields() {
        return {
            id: {
...
registerType(AccumoopindivtxType);
module.exports = AccumoopindivtxType;