...
var MemgroupcontractoptpopinsruleType = new GraphQLObjectType({
    name: 'Memgroupcontractoptpopinsrule',
    description: '@TODO DESCRIBE ME',

    fields: function getMemgroupcontractoptpopinsruleFields() {
        return {
            id: {
...
registerType(MemgroupcontractoptpopinsruleType);
module.exports = MemgroupcontractoptpopinsruleType;