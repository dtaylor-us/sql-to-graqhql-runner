...
var ProvdirsuppressType = new GraphQLObjectType({
    name: 'Provdirsuppress',
    description: '@TODO DESCRIBE ME',

    fields: function getProvdirsuppressFields() {
        return {
            id: {
...
registerType(ProvdirsuppressType);
module.exports = ProvdirsuppressType;