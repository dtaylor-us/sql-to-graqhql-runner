...
var AccumdeductindivtxType = new GraphQLObjectType({
    name: 'Accumdeductindivtx',
    description: '@TODO DESCRIBE ME',

    fields: function getAccumdeductindivtxFields() {
        return {
            id: {
...
registerType(AccumdeductindivtxType);
module.exports = AccumdeductindivtxType;