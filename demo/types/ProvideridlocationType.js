...
var ProvideridlocationType = new GraphQLObjectType({
    name: 'Provideridlocation',
    description: '@TODO DESCRIBE ME',

    fields: function getProvideridlocationFields() {
        return {
            id: {
...
registerType(ProvideridlocationType);
module.exports = ProvideridlocationType;