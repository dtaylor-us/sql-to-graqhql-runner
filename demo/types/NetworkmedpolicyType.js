...
var NetworkmedpolicyType = new GraphQLObjectType({
    name: 'Networkmedpolicy',
    description: '@TODO DESCRIBE ME',

    fields: function getNetworkmedpolicyFields() {
        return {
            id: {
...
registerType(NetworkmedpolicyType);
module.exports = NetworkmedpolicyType;