...
var MemberutilizationplanType = new GraphQLObjectType({
    name: 'Memberutilizationplan',
    description: '@TODO DESCRIBE ME',

    fields: function getMemberutilizationplanFields() {
        return {
            id: {
...
registerType(MemberutilizationplanType);
module.exports = MemberutilizationplanType;